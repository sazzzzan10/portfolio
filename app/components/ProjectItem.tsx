...
const ProjectItem = ({name, description, position, image, scrollable}:ProjectItemProps)=>{
    return (
                ...
                <div className={position%2!==0?"relative z-100 bg-linear-to-r from-[#800000]/30 vai-[#6d28d9]/30 to-transparent w-[100%] op-0 md:w-[135%] z-100 bg-gray-800/60 p-4 mt-2 rounded-lg":"relative z-100 bg-linear-to-r from-transparent vai-[#6d28d9]/30 to-[#800000]/30  top-0 md:-left-[35%] md:w-[135%] z-100 bg-gray-800/60 p-4 mt-2 rounded-lg"}>
{description}               </div>
                </div>
                <ScrollReveal stagger={0.2} className='relative p-0'>
                    ...
                    focus:hover:shadow-[0_0_40px_rgba(128,0,0,0.45)]">
                        ...
                        <div className="overflow-hidden h-[320px]" >
                            ...
                            <Image src={image} alt="abc"  width={582} height={320} className={scrollable?"w-full h-auto duration-3000 ease-linear group-hover:-translate-y-[55%] group-active:-translate-y-[55%] group-focus:-translate-y-[55%] ":"w-full h-auto duration-1000 ease-linear group-hover:-translate-y-[10%] group-active:-translate-y-[10%] group-focus:-translate-y-[10%] "}        style={{objectFit:"contain"}}/>
