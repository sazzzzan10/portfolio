        ...
        <section id="projects" className="relative py-28 space-y-24 ">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center ">
                ...
                <div className='relative p-0'>
                                            <div className='translate-y-10 pointer-events-none absolute -inset-12 md:-inset-18 rounded-4xl bg-linear-to-b from-[#7c3aed] vai-[#6d28d9]/30 to-transparent blur-[80px] opacity-50 -z-10'></div>
                    <div className="group cursor-pointer rounded-2xl overflow-hidden bg-[#0f061c]  shadow-[0_0_90px_rgba(168, 85, 247, 0.28)] transition-transform duration-300 
                    hover:shadow-[0_0_40px_rgba(168,85,247,0.45)]
                    focus:hover:shadow-[0_0_40px_rgba(168,85,247,0.45)]">
   

                        <div className="overflow-hidden h-[360px]">
                                                              
                            <Image src="/images/hero-fg.png" alt="abc" width={582} height={640} className="w-full h-auto duration-3000 ease-linear group-hover:-translate-y-[55%] group-active:-translate-y-[55%] group-focus:-translate-y-[55%]" />
