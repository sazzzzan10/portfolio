        ...
        <section id="projects" className="relative py-28 space-y-24 ">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center ">
                ...
                <div className="relative z-100  w-[100%]">
                    <div className='top-0 md:w-[135%] z-100 bg-gray-800/60 p-4 mt-2 rounded-lg'>An OJT training in construction surveying, gaining hands-on experience using a total station to measure angles, establish reference points and support accurate site layout and alignment</div>                </div>
                </div>
                ...
                <h1 className="text-2xl sm:text-2xl md:text-right font-normal tracking-light leading-[1.15]">
                Glam It Up
                </h1>
            
                    <div className='relative z-100  top-0 md:-left-[35%] md:w-[135%] z-100 bg-gray-800/60 p-4 mt-2 rounded-lg'>A simple website using HTML and CSS that displays makeup product details, featuring structured layouts, styled sections and user friendly presentation of product images, decriptions and pricing.</div>
                </div>
                <ScrollReveal stagger={0.2} className='relative p-0'>
                                            <div className='translate-y-10 pointer-events-none absolute -inset-12 md:-inset-18 rounded-4xl bg-linear-to-b from-[#800000] vai-[#6d28d9]/30 to-transparent blur-[80px] opacity-50 -z-10'></div>
                    <div className="group cursor-pointer rounded-2xl overflow-hidden bg-[#0f061c]  shadow-[0_0_90px_rgba(128, 0, 0, 0.28)] transition-transform duration-300 
