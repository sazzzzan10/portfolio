...
const Header = ()=>{
    ...
    return (
        <header className={`fixed top-0 left-0 right-0 z-999 transition-colors duration-300 ${isScrolled  || isOpen ? 'bg-[#0b0416]/80 background-blur-md shadow-[0_0_40px_rgba(113, 39,186,0.20)]':'bg-transparent'}`}>
