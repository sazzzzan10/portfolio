    ...
    return (
        <section id="contact" className=" relative">
            <ScrollReveal stagger={0.2} >
                ...
                About me</h3>
                 <div className='bg-linear-to-r from-[#800000]/30 vai-[#6d28d9]/30  pointer-events-none absolute -inset-12 md:top-[15%] md:bottom-[0] md:right-0 md:left-0 rounded-2xl  to-transparent p-4 mt-2 blur-sm  rounded-lg absolute '></div>
